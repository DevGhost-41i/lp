...
import { supabase, MCMParent } from '../lib/supabase';
import { X, Copy, Check } from 'lucide-react';
import { useNotification } from './NotificationContainer';
import { GAMService } from '../lib/gamService';

// Local interface for Partner type
interface Partner {
  id: string;
  full_name?: string;
  email: string;
...
export default function AddPublisherModal({
  ...
  const fetchParentMCMs = useCallback(async () => {
  ...
  }, [isOpen, userRole, fetchParentMCMs, fetchPartners]);
