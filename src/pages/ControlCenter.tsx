  ...
  if (loading) {
    return (
      <div className="flex flex-col h-full min-h-screen">
        {/* Header Skeleton */}
        <div className="px-6 pt-6 pb-6 animate-pulse">
          <div className="h-9 bg-[#2C2C2C] rounded w-64 mb-2"></div>
          <div className="h-5 bg-[#2C2C2C]/60 rounded w-96"></div>
        </div>

        {/* Tabs Skeleton */}
        <div className="px-6 animate-pulse">
          <div className="glass-panel p-1 rounded-lg w-fit flex gap-1">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-9 w-32 bg-[#2C2C2C] rounded-md"></div>
            ))}
          </div>
        </div>
        ...
        <div className="flex-1 px-6 py-6">
          <div className="space-y-4">
            <div className="flex justify-between items-center animate-pulse">
              <div className="h-7 bg-[#2C2C2C] rounded w-48"></div>
              ...
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="glass-card rounded-lg p-6 animate-pulse">
                  <div className="flex items-start justify-between mb-4">
                    <div className="h-12 w-12 bg-[#2C2C2C] rounded-lg"></div>
                    <div className="h-6 w-16 bg-[#2C2C2C] rounded"></div>
                  </div>
                  <div className="h-6 bg-[#2C2C2C] rounded w-3/4 mb-2"></div>
                  <div className="h-4 bg-[#2C2C2C]/60 rounded w-1/2 mb-4"></div>
                  <div className="space-y-2">
                    <div className="h-4 bg-[#2C2C2C]/40 rounded w-full"></div>
                    <div className="h-2 bg-[#1E1E1E] rounded-full"></div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="px-6">
          <div className="glass-panel p-1 rounded-lg w-fit flex gap-1">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'mcm-parents'
                ? 'bg-[#48a77f] text-white shadow-lg shadow-[#48a77f]/20'
                : 'text-gray-400 hover:text-white hover:bg-white/5'
                }`}
            >
            ...
            {['admin', 'super_admin'].includes(appUser?.role || '') && (
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'approvals'
                  ? 'bg-[#48a77f] text-white shadow-lg shadow-[#48a77f]/20'
                  : 'text-gray-400 hover:text-white hover:bg-white/5'
                  }`}
              >
                  ...
                  parents.map((parent) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <span
                          className={`px-2 py-1 rounded text-xs font-semibold ${parent.status === 'active' ? 'bg-[#48a77f]' : 'bg-[#1E1E1E]'
                            }`}
                        >
                          {parent.status}
                        </span>
                      ...
                      <div className="flex space-x-2 mt-4 pt-4 border-t border-[#2C2C2C]">
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center space-x-1 py-2 px-3 rounded text-sm transition-colors ${canEditMCMParent()
